// Depth-only pass from the light's point of view. The renderer binds
// lightViewProj at b0; each casting pass binds its per-object world at b1 and
// draws its geometry with no pixel shader.
