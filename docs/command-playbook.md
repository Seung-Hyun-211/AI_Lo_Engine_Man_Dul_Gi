...
- 상세 계약: `docs/engine-overview.md`, `multithreaded_game_engine_architecture.md`, `ui-architecture.md`, `scene-flow-design.md`, `game-settings.md`, `synopsis.md`, `entity-lifecycle-design.md`, `time-design.md`, `collider-design.md`, `model-animation-research.md`, `animation-design.md`, `shader-pipeline.md`, `toon-rendering.md`, `lighting.md`, `msaa.md`, `shadows.md`.
